            ...
            <div className="dashboard-container ml-[400px] pt-[50px]">
                  <div className="header-container">
                        <div className="text-button-container items-center mb-[4px] flex justify-between">
                              <h1 className="text-[20px] text-[#A1A1A1] font-bold ">Student Dashboard</h1>
                              <button onClick={()=>window.location.href="#download"} className="mr-[100px] h-[40px] gap-3 text-white w-[150px] cursor-pointer rounded-[5px] flex justify-center items-center duration-100 transition-all hover:bg-[#000092] bg-blue-600">Download <DownloadCloud></DownloadCloud></button>
                  ...
                  <div className="dashboard-content mt-[30px]">
                        ...
                        <div className="card-contents mt-[40px] flex gap-5 flex-wrap">
                              ...
                              <div className="cards-each-card w-[30%] h-[200px] flex flex-wrap-reverse justify-around items-center rounded-[20px] bg-[white] shadow-[#00000025] shadow-[0px_0px_10px]">
                                          ...
                                          <Link href="#view-more" className="text-blue-500">View more</Link>
                                    </div>
                                          </div>
                                    </div>
