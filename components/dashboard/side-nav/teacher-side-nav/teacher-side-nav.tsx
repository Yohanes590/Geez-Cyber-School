"use client"
import { BookCopy, Clock, Folder, LayoutDashboard, MessageCircle, Settings ,Users} from "lucide-react"
...
export default function TeacherSideNav() {
      ...
      <div className="side-nav-container z-40 w-[350px] rounded-[0px_20px_20px_0px] bg-white shadow-[#00000038] shadow-[0_0_20px] fixed h-[100%]">
                  ...
                  <div className="click-container w-[100%] flex justify-center mt-[50px]">
                        ...
                        <div className="click-time mt-[5px] flex rounded-[10px] w-[100%] gap-2 items-center pl-[20px] cursor-pointer text-blue-500 h-[65px] transition-all duration-500 hover:bg-[#f1f5ff]"><Users/>Students</div>
